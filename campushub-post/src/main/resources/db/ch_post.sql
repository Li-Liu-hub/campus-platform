...
(
    ...
    `post_view_number`     BIGINT       NOT NULL DEFAULT 0 COMMENT '帖子浏览量统计，浏览增量由定时任务从 Redis 折叠落库',
    `post_like_number`     BIGINT       NOT NULL DEFAULT 0 COMMENT '帖子点赞数，互动事件异步聚合维护的冗余计数',
    `post_collect_number`  BIGINT       NOT NULL DEFAULT 0 COMMENT '帖子收藏数，互动事件异步聚合维护的冗余计数',
